...
public final class QrCode {
    ...
    private final DadosEnvio dadosPix;
    ...
    public QrCode(final DadosEnvio dadosPix) {
     ...
     * @see QrCode#QrCode(DadosEnvio)
     * @throws IllegalArgumentException quando o ID da transação é inválido
     */
    public QrCode(final DadosEnvio dadosPix, final String idTransacao) {
    ...
    private JSONObject newJSONObject() {
        ...
        final var json =
                jsonTemplate
                        .formatted(
                                PFI, ARRANJO_PAGAMENTO, dadosPix.chavePIX().chave(), dadosPix.descricao(),
                                MCC, COD_MOEDA, COD_CAMPO_VALOR, dadosPix.valorStr(), COD_PAIS,
                                dadosPix.chavePIX().nome(), dadosPix.cidadeRemetente(), idTransacao);
